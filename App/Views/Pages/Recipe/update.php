<h1 class="text-primary text-center">Editar receita</h1>

<form action="/pratonosso/recipes/update/<?php echo $recipe[0]->id?>" method="POST">
  ...
  <div class="form-group mb-4">
    ...
    <input type="text" class="form-control" name="title" placeholder="ex: Bolo de Chocolate, Frango Assado, etc" required value="<?php echo $recipe[0]->title?>">
  </div>
  <div class="form-group mb-4">
    <label for="" class="lead">Descrição:</label>
    <textarea name="description" class="form-control" placeholder="ex: Lasanha feita apenas com ingredientes naturais"><?php echo $recipe[0]->description;?></textarea>
  </div>
      ...
      <div class="mb-5 integrants">
        <div class="form-group mb-4">
          <label class="lead">Título:</label>
            <input name="integrant_title[]" type="text" class="form-control" placeholder="ex: Molho, Massa, Calda..." required value="<?php echo $recp->integrant_title?>">
        </div>
        <div class="form-group mb-4">
          <label for="" class="lead">Ingredientes:</label>
          <textarea name="integrant_ingredients[]" class="form-control" placeholder="ex: 3 xícaras de farinha, 2 colheres de sopa de óleo..."><?php echo $recp->integrant_ingredients?></textarea>
        </div>
        <div class="form-group mb-4">
          <label for="" class="lead">Modo de preparo:</label>
            <textarea name="integrant_directions[]" class="form-control" placeholder="ex: Misturar a farinha com o óleo em uma tigela..."><?php echo $recp->integrant_direction?></textarea>
        </div>
